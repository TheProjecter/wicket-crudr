...
public class AutoDisplay<T extends Serializable> extends Panel implements Serializable {
    ...
    protected void onInitialize() {
        ...
        StyleableBorder myBorder = getBorder();
        myBorder.addToBorder(webMarkupContainer);
    ...
    protected void onBeforeRender() {
        ...
        for (IDataBlock<T> block: blocks) {
            Fragment fragment = new DisplayFragment(view.newChildId(), myBorder.getFragmentId(), myBorder);
