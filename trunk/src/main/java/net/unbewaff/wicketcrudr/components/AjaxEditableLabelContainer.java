...
public class AjaxEditableLabelContainer<T> extends Panel {
         ...
         * @param configuration
         */
        public AjaxEditableLabelContainer(final String id, final IModel<T> model,
                        ContainerConfiguration<T> configuration) {
                super(id, model);
        ...
        /**
         * Hook used by ILabelProviders to create new Labels. These can come in form of simple Labels or more complex
         * Wicket Components
         * @param parent unused right now. Inherited from AjaxEditableLabel
         * @param componentId The ID for the component to create
         * @param model The Model to use by the component
         * @return A component that will be used as the display-variant of the in-place-editor
         */
        protected Component newLabel(MarkupContainer parent, String componentId, IModel<T> model) {
                return labelProvider.newLabel(componentId, model);
        }

        /**
         * Hook used by IEditorProviders to create FormComponents. These will be added to the result of newSurroundingPanel
         * since FormComponents don't come with their own Markup
         * @param parent unused right now. Inherited from AjaxEditableLabel
         * @param componentId The ID for the component to create
         * @param model The Model to use by the component
         * @return The matching FormComponent to the Markup provided by newSurroundingPanel
         */
        protected FormComponent<T> newEditor(MarkupContainer parent,String componentId, IModel<T> model) {
                return editorProvider.newEditor(componentId, model);
        }

        /**
         * Hook used by ISurroundingContainerProviders to create a Component with matching Markup to accept the FormComponent
         * of newEditor.
         * @param parent unused right now. Inherited from AjaxEditableLabel
         * @param componentId The ID for the component to create
         * @return A WebMarkupContainer providing a matching input or select tag with the wicket:id "editor" to accept
         * the FormComponent provided by newEditor
         */
        ...
        protected class EditorAjaxBehavior extends AbstractDefaultAjaxBehavior {
                ...
                protected void onComponentTag(final ComponentTag tag) {
                        ...
                        final String cancelCall = "{"
                                        + generateCallbackScript("wicketAjaxGet('" + callbackUrl
                                                        + separator + "save=false'") + "; return false;}";

                        final String keypress = "var kc=wicketKeyCode(event); if (kc==27) "
                                        + cancelCall + " else if (kc!=13) { return true; } else "
                                        + saveCall;
                ...
                protected void respond(final AjaxRequestTarget target) {
                        ...
                        boolean save = requestCycle.getRequest().getRequestParameters()
                                        .getParameterValue("save").toBoolean(false);
