...
public class ContainerConfiguration<T> {
        ...
        /**
         * Convenience Parameter Object to encapsule the providers needed by FlexibleColumns into a single
         * parameter
         * @param labelProvider The ILabelProvider
         * @param editorProvider The IEditorProvider
         * @param containerProvider The ISurroundingContainerProvider
         */
        public ContainerConfiguration(ILabelProvider<T> labelProvider,
                        IEditorProvider<T> editorProvider,
