...
public abstract class PalettePanel<T> extends Panel {
	...
	protected Component newAvailableHeader(final String componentId) {
		return new Label(componentId, new ResourceModel("palette.available",
				"Available"));
	}
		...
		return new PaletteButton("moveDownButton") {
			...
			protected void onComponentTag(final ComponentTag tag) {
				...
				tag.getAttributes().put("onclick",
						PalettePanel.this.getDownOnClickJS());
			}
		};
	}
	...
	protected Component newUpComponent() {
		return new PaletteButton("moveUpButton") {
			...
			protected void onComponentTag(final ComponentTag tag) {
				super.onComponentTag(tag);
				tag.getAttributes().put("onclick",
						PalettePanel.this.getUpOnClickJS());
			}
		};
	}
	...
	protected Component newRemoveComponent() {
		return new PaletteButton("removeButton") {
			...
			protected void onComponentTag(final ComponentTag tag) {
				super.onComponentTag(tag);
				tag.getAttributes().put("onclick",
						PalettePanel.this.getRemoveOnClickJS());
			}
		};
	}
	...
	protected Component newAddComponent() {
		return new PaletteButton("addButton") {
			...
			protected void onComponentTag(final ComponentTag tag) {
				super.onComponentTag(tag);
				tag.getAttributes().put("onclick",
						PalettePanel.this.getAddOnClickJS());
			}
		};
	}
	...
	protected Component newSelectionComponent() {
		return new Selection<T>("selection", this) {
			...
			protected Map<String, String> getAdditionalAttributes(
					final Object choice) {
				return PalettePanel.this
						.getAdditionalAttributesForSelection(choice);
			}
		};
	}
	 ...
	 */
	protected Map<String, String> getAdditionalAttributesForSelection(
			final Object choice) {
		return null;
	}
	...
	protected Component newChoicesComponent() {
		return new Choices<T>("choices", this) {
			...
			protected Map<String, String> getAdditionalAttributes(
					final Object choice) {
				return PalettePanel.this
						.getAdditionalAttributesForChoices(choice);
			}
		};
	}
	...
	protected String buildJSCall(final String funcName) {
		return new StringBuilder(funcName).append("('")
				.append(getChoicesComponent().getMarkupId()).append("','")
				.append(getSelectionComponent().getMarkupId()).append("','")
				.append(getRecorderComponent().getMarkupId()).append("');")
				.toString();
	}
