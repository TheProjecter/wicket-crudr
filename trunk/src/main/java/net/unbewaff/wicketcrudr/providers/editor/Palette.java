...
public class Palette<T> extends HiddenField<T> {
	 ...
	 */
	public PalettePanel<T> getPalettePanel() {
		return palette;
	}
	 ...
	 */
	public Palette(final String id, final PalettePanel<T> palette) {
		super(id);
	...
	private void initIds() {
		...
		while (selection.hasNext()) {
			modelStringBuffer
					.append(renderer.getIdValue(selection.next(), i++));
